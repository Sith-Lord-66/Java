...
public class Q4 {
    ...
    /**
     * To parse the text contained within a String into its Token Types
    ...
    public static void scan(String fname) {
        ...
        while (index < fileLength) {
            ...
            //Prints the Token type for characters that are symbols along with the line number and character
            else if (symbol != null) {

                System.out.println(lineNumber + ", " + symbol + ", " + character);
                index++;
            }
            //Prints the Token type for characters that are operators along with the line number and character
                ...
                //Checks for a two character operator such as "==" and prints out the token type
                ...
                //If a single character operator is present, then it prints its token type
                else {
            ...
            //Joins multiple characters together into a String (word)
                ...
                /*Checks the string word to see if it is a keyword or hobbit, and if neither an identifier
                Then it prints the token type that corresponds with String word
                 */
            ...
            //Prints the token type for integers where present
            else  if (digit) {
                ...
                //Checks that all digits are included such as "10" instead of "1"
                while (index < fileLength) {
            ...
            Then it prints its token type along with the String and line number
            */
            else if (character == '\"') {
                ...
                //Adds characters to a String (ch) until there is a quotation mark
                while (index < fileLength) {
